								...
								<ul class="nav nav-collapse">
									<li>
										<a href="../demo1/index.html">
											<span class="sub-item">Estadisticas</span>
										</a>
									</li>
									<li>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="sidebar-style-1.html">
											<span class="sub-item">Todos los Cursos</span>
										</a>
									</li>
									<li>
										<a href="overlay-sidebar.html">
											<span class="sub-item">Cursos Iniciados</span>
										</a>
									</li>
									<li>
										<a href="compact-sidebar.html">
											<span class="sub-item">Cursos Terminados</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="forms/forms.html">
											<span class="sub-item">Todas las Peliculas</span>
										</a>
									</li>
									<li>
										<a href="forms/forms.html">
											<span class="sub-item">Peliculas vistas</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="tables/tables.html">
											<span class="sub-item">Todos los Libros</span>
										</a>
									</li>
									<li>
										<a href="tables/datatables.html">
											<span class="sub-item">Libros Iniciados</span>
										</a>
									</li>
									<li>
										<a href="tables/datatables.html">
											<span class="sub-item">Libros Terminados</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="maps/jqvmap.html">
											<span class="sub-item">Todos los Juegos</span>
										</a>
									</li>
									<li>
										<a href="maps/jqvmap.html">
											<span class="sub-item">Estadisticas de Juegos</span>
										</a>
									</li>
								</ul>
							</div>
