...
<body>
    ...
    <img src="{{URL::asset('assets/img/grande_oscuro.png')}}" alt="logo" class="logo" width="270">
    <div class="c-formContainer">
    <div class="c-welcome">
        Bienvenido a el fututro!
    ...
    <form class="c-form" action="">
        ...
        <span class="c-form__groupLabel">Crea un usario que no puedas olvidar.</span>
