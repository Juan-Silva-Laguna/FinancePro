...
<body>
<center><h1>BLOQUES</h1></center>
<div id="container">
	<div id="game"></div>
	<div id="score">0</div>
	<div class="game-over">
		<h2>Juego terminado</h2>
		<p>Lo hiciste genial, eres bueno.</p>
		<p>Haz clic o barra espaciadora para empezar de nuevo.</p>
	</div>
...
var Game = /** @class */ (function() {
  ...
  Game.prototype.endGame = function() {
    alert("Conseguiste "+String(this.blocks.length - 2)+" puntos ");
