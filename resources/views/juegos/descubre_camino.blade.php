...
<head>
    ...
    <style>
        ...
        .refresh:hover, .fullscreen:hover {
        color: #000038;
        ...
        position: absolute;
        bottom: -4rem;
        content: "Haga clic en las flechas para jugar";
        color: #fff;
        font-size: 1.2rem;
        font-weight: 500;
        text-align: center;
        ...
        .game--win:after {
        content: "¡Ganaste! Siguiente nivel";
        }
        .game--lose:after {
        content: "¡Perdiste! Intentar otra vez!";
        }
        ...
        background-image: url('https://images.vexels.com/media/users/3/141265/isolated/preview/eb2271c1e561a6b8588e13310b4d580c-deportista-corriendo-silueta.png');
        ...
        .game__cell--rock {
            /* background: #000038; */
            background-image: url('https://images.vexels.com/media/users/3/145874/isolated/preview/b55eccb8fb67c9fd017e5df9f47cab3e-roca-de-piedra.png');
            background-size: auto 100%;
        }
        .game__cell--lava {
            /* background: linear-gradient(45deg, orange, #ff7d66 150%); */
            background-image: url('https://images.emojiterra.com/google/noto-emoji/unicode-15/animated/1f525.gif');
            background-size: auto 100%;
        }
        .game__cell--stop {
            position: relative;
        ...
        .game__cell--end {
            /* background: #80c0a1; */
            background-image: url('https://cdn-icons-png.flaticon.com/512/1/1647.png');
            background-size: auto 100%;
        }
...
<body>
    ...
    <div id="level-text" style="display: none;" class="level">0</div>
    <div id="refresh" class="refresh">Reiniciar</div>
    <div id="timer" class="timer"></div>
    <div id="title-screen" class="title-screen">
<center>    <div class="title-screen__title">BUSCA <span class="title-screen__word">CAMINO</span></div>
<p>Haga click en la flechas para moverse</p>
</center>
    <button id="title-screen-button" class="title-screen__button">Iniciar</button>
    </div>
    <div id="fullscreen" class="fullscreen">Pantalla Completa</div>
</body>
<script>
    ...
    var nivelAleatorio = Math.floor(Math.random() * (51 - 5 + 1)) + 5;

    let level =  Math.floor(Math.random() * (8 - 1 + 1)) + 1;//0;
    let width = 29;
    const puzzles = [
    ["ox---", "---xe"],
    ["ox---", "---xe", "--xxx"],
    ...
    alert("has ganado puntos campeon");
