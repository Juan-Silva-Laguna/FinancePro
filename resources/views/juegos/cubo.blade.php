...
<body>
    <div class="ui">
        ...
        <div class="ui__prefs">
            <range name="size" title="Tamaño" list="2,3,4,5"></range>
            <range name="flip" title="Tipo de giro" list="Rapido&nbsp;,Liso,Rebotar"></range>
            <range name="scramble" title="Longitud" list="20,25,30"></range>
            <range name="fov" title="Angulo de Camara" list="Ortografico,Perspectiva"></range>
            <range name="theme" title="Esquema de colores" list="Cubo,Erno,Polvo,Camuflaje,Lluvia"></range>
        </div>
