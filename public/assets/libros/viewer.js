...
const PDFViewerApplication = {
  ...
  setInitialView(storedHash, {
    ...
    //SE VEN HOJAS COMPLETAS
    this.pdfViewer.currentScaleValue = "page-fit";

    //QUITAR SCROLL DE TODAS LAS PAGINAS
    scrollMode=3;

    //SE VEN DE A DOS PAGINAS
    if (window.innerWidth > 767) {
        //si es pantalla grande muestra de a dos paginas
        spreadMode=2;
    }

    //PAGINA EN LA QUE A LEIDO
    const id = document.getElementById("idLibro").value;
    $.ajax({
        type: 'GET',
        url: `/libros/visto/${id}/${null}`,
        dataType: 'json',
        success: function (data) {
            PDFViewerApplication.setearPage( parseInt(data));
        },
  ...
  setearPage(o){
    this.pdfViewer.currentPageNumber = o;
  },
  afterPrint() {
...
}
{
  defaultOptions.defaultUrl = {
    value:  document.getElementById("rutaLibro").value +".pdf",
    kind: OptionKind.VIEWER
  };
...
class GenericL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_3__.L10n {
  constructor(lang) {
    ...
    this._setL10n(new fluent_dom__WEBPACK_IMPORTED_MODULE_1__.DOMLocalization([], GenericL10n.#generateBundles.bind(GenericL10n, "es-es", this.getLanguage())));
  }
...
class L10n {
  ...
  static #fixupLangCode(langCode) {
    langCode = langCode?.toLowerCase() || "es-es";
...
class ConstL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_3__.L10n {
  ...
  static get instance() {
    return (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.shadow)(this, "instance", new ConstL10n("es-es"));
  }
}
const NullL10n = {
  getLanguage() {
...
const NON_METRIC_LOCALES = ["es-es", "en-lr", "my"];
const US_PAGE_NAMES = {
  "8.5x11": "letter",
  "8.5x14": "legal"
};
...
class PDFViewer {
  ...
  _resetView() {
    ...
    this._currentScaleValue = "page-fit";
    this.#setScale(this._currentScaleValue, {
      noScroll: false
    });
  }
  ...
  #setScale(value, options) {
    ...
    if (scale > 0) {
      ...
      console.log(scale, value, options, currentPage);
